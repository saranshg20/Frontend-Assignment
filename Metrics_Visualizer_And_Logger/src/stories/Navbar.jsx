...
function Navbar({ showMetrics, duration, setDuration }) {
    ...
    return (
        <div className="flex bg-white items-center w-full pl-[32px] pr-[32px] pb-[17px] pt-[17px]">
            <div>
                    ...
                    <Link to="/metrics">
                        <div className="flex cursor-pointer pr-[4px] items-center">
                            <img
                                ...
                                src={`${
                                    showMetrics
                                        ? "Sidepane/metrics.png"
                                        : "Sidepane/metrics-gray.png"
                                }`}
                                alt=""
                            />
                            <span
                                className={`${
                                    showMetrics ? "font-bold" : ""
                                } ml-[7px]`}
                            >
                                Metrics
                            </span>
                ...
                <div className="w-full flex items-center justify-between">
                    ...
                    <div className="relative">
                        <div>
                            <button
                                type="button"
                                className="flex w-full gap-x-1.5 rounded-md bg-white px-3 py-2 text-sm font-semibold text-gray-900 shadow-sm ring-1 ring-inset ring-gray-300 hover:bg-gray-50"
                                id="menu-button"
                                aria-expanded="true"
                                aria-haspopup="true"
